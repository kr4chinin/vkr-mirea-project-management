...
3. Страница проекта, проектных задач и мониторинга проекта:
...
4. Страница проектной аналитики (по всем пользователям, проектам и задачам в системе):
...
5. Профиль пользователя (с использлванием Clerk-провайдера):
...
*Ниже предстлавлена часть заключение из **ВКР**.*
